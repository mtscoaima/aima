...
**예상 결과:**
- [ ] 이미지 업로드 섹션 토글 동작
- [ ] MTS 이미지 업로드 API 성공 (`/api/messages/upload-image`)
- [ ] 이미지 미리보기 표시 (썸네일, 파일명, 파일 크기)
- [ ] Console.log 자동 감지 메시지: `FI (이미지형)`
