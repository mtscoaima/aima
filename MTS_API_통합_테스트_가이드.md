...
1. [테스트 개요](#테스트-개요)
2. [테스트 진행 방법](#테스트-진행-방법)
3. [테스트 환경 설정](#테스트-환경-설정)
4. [Phase 1: SMS/LMS/MMS 즉시 발송 테스트](#phase-1-smslmsmms-즉시-발송-테스트)
5. [Phase 2: SMS/LMS/MMS 예약 발송 테스트](#phase-2-smslmsmms-예약-발송-테스트)
6. [Phase 3: 카카오 알림톡 테스트](#phase-3-카카오-알림톡-테스트)
7. [Phase 4: 카카오 친구톡 V2 테스트](#phase-4-카카오-친구톡-v2-테스트)
8. [Phase 5: 네이버 톡톡 테스트](#phase-5-네이버-톡톡-테스트)
9. [Phase 6: 카카오 브랜드 메시지 테스트](#phase-6-카카오-브랜드-메시지-테스트)
10. [Phase 7: 시스템 알림 테스트](#phase-7-시스템-알림-테스트)
11. [Phase 8: Cron Job 예약 발송 테스트](#phase-8-cron-job-예약-발송-테스트)
12. [에러 핸들링 테스트](#에러-핸들링-테스트)
13. [성능 테스트](#성능-테스트)
...
- [ ] 변수 치환 정확성 확인
- [ ] 잔액 15원 차감 확인
- [ ] message_logs에 message_type='KAKAO_ALIMTALK' 저장 확인
...
- [ ] 버튼명 입력 (예: "자세히 보기")
- [ ] 버튼 타입 선택 (WL: 웹링크)
- [ ] url_mobile 입력 (https://example.com/order/12345)
- [ ] 발송 성공 확인
- [ ] 카카오톡 수신 메시지에 버튼 표시 확인
- [ ] 버튼 클릭 시 올바른 URL로 이동 확인
- [ ] 모바일 브라우저에서 페이지 정상 표시 확인
- [ ] URL 파라미터 정확히 전달 확인

#### ✅ 3.3 알림톡 → SMS 전환 발송
- [ ] 전환 발송 옵션 설정 (tran_type, tran_message)
- [ ] 알림톡 친구 미등록 번호로 발송 시도
- [ ] 알림톡 발송 실패 확인 (친구 아님)
- [ ] SMS로 자동 전환 발송 확인
- [ ] 전환 메시지 내용 tran_message와 일치 확인
- [ ] 잔액 차감: 알림톡(15원) + SMS(20원) = 35원 확인
- [ ] message_logs에 전환 발송 기록 확인
- [ ] metadata에 tran_type, tran_message 저장 확인
...
- [ ] 알림톡과 구분되는 UI 확인
- [ ] 잔액 30원 차감 확인
- [ ] message_logs에 message_type='KAKAO_FRIENDTALK' 저장 확인
...
- [ ] 템플릿 내용 정확히 치환 확인
- [ ] 잔액 15원 차감 확인
- [ ] message_logs에 message_type='NAVER_TALK' 저장 확인
...
- [ ] 카카오톡 브랜드 메시지 수신 확인
- [ ] 잔액 15원 차감 확인
- [ ] message_logs에 message_type='KAKAO_BRAND' 저장 확인
...
- [ ] message_type = 'KAKAO_ALIMTALK' 확인
...
#### ✅ 8.2 카카오 친구톡 예약 발송
- [ ] DB에 친구톡 예약 데이터 삽입
- [ ] message_type = 'KAKAO_FRIENDTALK' 확인
...
- [MTS Message 코드베이스 분석](./MTS_MESSAGE_코드베이스_분석_v3.0.md)
