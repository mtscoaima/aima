...
```
28. ⬜ mtsApi.ts에 친구톡 V2 함수 추가
    - sendKakaoFriendtalk() - V2 단건 발송
    - sendKakaoFriendtalkBulk() - V2 복수 발송
29. ⬜ API 엔드포인트 생성
    - /api/messages/kakao/friendtalk/send
30. ⬜ KakaoMessageContent.tsx 친구톡 탭 수정
...
### Phase 8: 네이버 톡톡 구현 (예정)
```
31. ⬜ mtsApi.ts에 네이버 톡톡 함수 추가
    - sendNaverTalk() - 톡톡 발송
    - getNaverTalkTemplates() - 템플릿 조회
32. ⬜ API 엔드포인트 생성
    - /api/messages/naver/talk/send
    - /api/naver/templates
33. ⬜ NaverTalkContent.tsx 수정
    - 톡톡 ID 선택 드롭다운
    - 템플릿 선택 및 변수 치환
    - 발송 버튼 추가 및 API 호출
```
...
- [ ] KakaoMessageContent.tsx 친구톡 탭 수정
  - [ ] messageType 선택 UI (FT/FI/FW/FL/FC)
  - [ ] ad_flag 체크박스 UI (광고성 여부)
  - [ ] 이미지 업로드 UI (이미지형만)
  - [ ] 버튼 설정 UI
  - [ ] 발송 버튼 및 API 호출
- [ ] TypeScript 컴파일 에러 0개 확인
...
### ⏳ Phase 8: 네이버 톡톡 구현 (예정)
- [ ] mtsApi.ts에 네이버 톡톡 함수 추가
  - [ ] sendNaverTalk() - 톡톡 발송
  - [ ] getNaverTalkTemplates() - 템플릿 조회
- [ ] API 엔드포인트 생성
  - [ ] /api/naver/templates/route.ts
  - [ ] /api/messages/naver/talk/send/route.ts
- [ ] NaverTalkContent.tsx 수정
  - [ ] 톡톡 ID 선택 드롭다운
  - [ ] 템플릿 선택 드롭다운 (API 조회)
  - [ ] 템플릿 변수 치환 입력 UI
  - [ ] 버튼 설정 UI
