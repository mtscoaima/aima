...
import { ChevronDown, Eye, FileText, ChevronLeft, ChevronRight } from "lucide-react";

const RcsTemplateTab = () => {
  const [selectedBrand, setSelectedBrand] = useState("전체 브랜드");
    ...
    <div className="flex-1">
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        ...
        <div className="flex items-end gap-2">
          <button className="bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 text-sm font-medium">
            검색
          </button>
          <button className="border border-gray-300 text-gray-700 px-4 py-3 rounded-lg hover:bg-gray-50 text-sm">
            검색 초기화
          </button>
        </div>
      </div>
      ...
      <div className="flex justify-between items-center mb-6">
        <div className="flex gap-2">
          ...
          <button className="border border-blue-600 text-blue-600 px-4 py-2 rounded-lg flex items-center gap-2 text-sm hover:bg-blue-50">
      ...
      <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
        ...
        <div className="p-16 text-center">
          <p className="text-gray-500 text-lg">RCS 템플릿 목록이 없습니다.</p>
        </div>
      </div>
