        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              {/* 메시지 보내기 */}
              <div 
                onClick={() => handleMenuClick('/messages/reservations/message/send')}
              ...
              {/* 보낸 메시지 */}
              <div 
                onClick={() => handleMenuClick('/messages/reservations/message/list')}
                className="bg-white rounded-lg p-4 border border-gray-200 cursor-pointer hover:bg-gray-50 transition-colors duration-200 flex items-center justify-between"
              >
              ...
              {/* 내 템플릿 관리 */}
              <div 
                onClick={() => handleMenuClick('/messages/reservations/message/templates')}
                className="bg-white rounded-lg p-4 border border-gray-200 cursor-pointer hover:bg-gray-50 transition-colors duration-200 flex items-center justify-between"
              >
              ...
              {/* 발신자 정보 설정 */}
              <div 
                onClick={() => handleMenuClick('/messages/reservations/message/sender-contact')}
                className="bg-white rounded-lg p-4 border border-gray-200 cursor-pointer hover:bg-gray-50 transition-colors duration-200 flex items-center justify-between"
              >
            ...
            <div className="space-y-2">
              {/* 자동 메시지 설정 */}
              <div 
                onClick={() => handleMenuClick('/messages/reservations/message/auto')}
                className="bg-white rounded-lg p-4 border border-gray-200 cursor-pointer hover:bg-gray-50 transition-colors duration-200 flex items-center justify-between"
              >
              ...
              {/* 발송 예정 메시지 */}
              <div 
                onClick={() => handleMenuClick('/messages/reservations/message/list/reserved')}
                className="bg-white rounded-lg p-4 border border-gray-200 cursor-pointer hover:bg-gray-50 transition-colors duration-200 flex items-center justify-between"
              >
