  ...
  return (
    <div className="p-4 max-w-5xl mx-auto">
      ...
      <div className="bg-white rounded-lg shadow p-4 mb-6 border-t-4 border-t-blue-500">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <p className="font-medium text-black">{userData.joinDate || "-"}</p>
          </div>
          <div>
      ...
      <div className="bg-white rounded-lg shadow p-4 mb-6">
        <h2 className="text-lg font-semibold mb-4 text-black">SNS 계정 연동</h2>
        <div className="space-y-4">
            ...
            <div className="relative bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
              ...
              <div className="p-4 max-h-[70vh] overflow-auto">
                <div className="flex justify-center">
                  ...
                  {showPreviewModal.fileName.toLowerCase().includes(".pdf") ? (
