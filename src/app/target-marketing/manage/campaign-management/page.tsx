...
export default function CampaignManagementPage() {
  ...
  const [filter, setFilter] = useState<
    "all" | "active" | "pending" | "completed" | "inactive"
  >("all");
  const [sort, setSort] = useState<"newest" | "oldest" | "name" | "conversion">(
    "newest"
  );
            ...
            {filteredCampaigns.map((campaign) => (
              <div
                ...
                className={`campaign-row ${
                  campaign.status === "inactive" ? "inactive-campaign" : ""
                }`}
              >
                <div className="campaign-name-col">
                  <div className="campaign-name">{campaign.name}</div>
                  <div className="campaign-modified">
                    최종수정:{" "}
                ...
                <div className="campaign-metrics-col">
                  ...
                  <div>
                    반응: {campaign.metrics.responded.toLocaleString()}건
                  </div>
                ...
                <div className="campaign-actions-col">
                  <Link
                    href={`/target-marketing/send/register-campaign?edit=${campaign.id}`}
                  >
