      ...
      <div className="container mx-auto p-6">
        ...
        <div className="border-b pb-6 mb-6">
          ...
          <div className="grid grid-cols-[150px_1fr] gap-4 items-center">
            ...
            <div
              className="w-16 h-8 bg-gray-300 rounded-full p-1 cursor-pointer relative"
            ...
            >
              ...
              ></div>
              <span
                className={`absolute left-3 top-1.5 text-white text-xs ${
              ...
              <span
                className={`absolute right-3 top-1.5 text-white text-xs ${
            ...
            <div className="flex space-x-2">
              <button
                className={`px-6 py-2 border rounded ${
                  gender === "전체" ? "bg-blue-100 border-blue-300" : "bg-white"
                }`}
              ...
              <button
                className={`px-6 py-2 border rounded ${
                  gender === "남성" ? "bg-blue-100 border-blue-300" : "bg-white"
                }`}
              ...
              <button
                className={`px-6 py-2 border rounded ${
                  gender === "여성" ? "bg-blue-100 border-blue-300" : "bg-white"
                }`}
        ...
        <div className="border-b pb-6 mb-6">
          ...
          <div className="grid grid-cols-[150px_1fr] gap-4 items-center mb-4">
            ...
            <div className="flex items-center gap-6">
              ...
              <select
                className="border rounded p-2 w-32"
                disabled={!storeLocationSpecific}
              >
                <option>시/도</option>
              </select>
              <select
        ...
        <div className="border-t pt-6 mt-4 flex justify-end">
          <button className="bg-gray-200 text-gray-800 px-6 py-2 rounded mr-2">
            취소
          </button>
